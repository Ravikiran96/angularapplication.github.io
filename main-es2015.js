...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<p>{{product?.notes}} </p>\n       <!-- <p>{{product?.description}} </p> -->\n        \n");
